...
- **Próximo passo natural**: Issue #12 (`goals` — usa o catálogo de calculadoras da #10 + o peso mais recente da #11 pra calcular TMB/TDEE/macros de verdade) ou #13 (catálogo de alimentos/TACO) em paralelo, conforme `docs/backlog-fase2.md`.
