...
- **Auto-deploy no push**: GitHub App do Render foi instalado nesta sessão (antes só havia login OAuth, sem o app de verdade — por isso o webhook nunca disparava). Ainda não confirmado se resolveu de fato — testar no próximo push real e atualizar este parágrafo com o resultado.
