...
Pré-requisitos: Node.js >= 24, [pnpm](https://pnpm.io/installation) >= 9.
...
Cada workspace individual roda via `pnpm --filter <nome> <script>`, ex.: `pnpm --filter @minhasaude/api dev`.
