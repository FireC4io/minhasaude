...
- ✅ **Auto-deploy do Render**: funcionando desde 2026-09-18 — GitHub App instalado e testado com um push real (deploy disparou sozinho, ficou `live`). Deploy manual continua disponível se precisar: `curl -X POST -H "Authorization: Bearer $RENDER_API_KEY" https://api.render.com/v1/services/srv-dam2ng6k1f9s73e8ok1g/deploys`.
